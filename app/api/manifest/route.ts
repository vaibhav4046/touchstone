    ...
    services: [
      {
        ...
        price: {
          ...
          isPaid: true,
          note: "For the run. What a seller charges comes out of the budget you set.",
        },
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: true,
          note: "Cheap on purpose. We would rather you checked a listing than guessed.",
        },
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: true,
          note: "One call, every listing assayed, one receipt each.",
        },
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: false,
          note: "Free. This is the participant, not a product: an organiser or a rival drives it.",
        },
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: false,
          note: "Free, and the assay it runs on your listing is free with it. We would rather the book were full of listings that survive reading.",
        },
        ...
        input: {
          ...
          capabilities: 'array of dotted verbs ("research.brief") or {id, summary} (at least 1, at most 12)',
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: false,
          note: "Free. A verdict only we can confirm is not evidence.",
        },
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: false,
          note: "Free. A signature only the issuer can check is not evidence.",
        },
        input: "Nothing.",
        output:
      ...
      },
      {
        ...
        price: {
          ...
          currency: "arena-credits",
          isPaid: false,
          note: "Free and non-consuming. Reading that a door exists is not opening it.",
        },
